			...
			<>
				...
				<Container style={{backgroundColor:"#"}}>
					<Header style={styles.headerBackgroundColor} button>
						...
						<Body>
							<ListItem noBorder button onPress={()=>{this.setShow()}}>
									<Title >
										Added paritcipants
									</Title>
							</ListItem>
					...
					<Card style={{height:120}}>
						<ListItem avatar noBorder button style={{marginTop:15}}>
							<View style={{marginBottom:65,marginLeft:-20}}>
								<Fab position="topLeft" style={{backgroundColor:"#B9B9BB"}}>
									<Icon name="photo-camera" type="MaterialIcons" style={{fontSize: 28}}/>
								</Fab>
							</View>
			...
			<Container >
				...
				<View>
					<ScrollView horizontal={true}>
						<Header noLeft style={styles.newgroupheader} noBorder>
							<Body style={{marginRight:25}}>
								...
								<Text style={styles.removeText}>Abhinav</Text>
							</Body>
						</Header>
					</ScrollView>
				</View>
				...
				<Fab position="bottomRight" style={{backgroundColor:"#075E54"}} button onPress={()=>{this.setShow()}}>
