...
export default function GroupsExcept({navigation}) {
	...
	return (
			<Container>
				<Header style={{backgroundColor:"#05F8EC",width:"100%"}} button>
					...
					<Body>
                        <Title onPress={()=>{navigation.navigate('Status')}} style={{color:"#000000"}}>Add me to group</Title>
						<Text style={{color:"#000000"}}>No contacts included</Text>
                    </Body>
					<Right>
						<Button transparent>
