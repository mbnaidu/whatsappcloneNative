...
export default function Only({navigation}) {
	...
	return (
			<Container>
				<Header style={{backgroundColor:"#05F8EC",width:"100%"}} button>
					...
					<Body>
                        <Title onPress={()=>{navigation.navigate('Status')}} style={{color:"#000000"}}>Show status only for ...</Title>
						<Text style={{color:"#000000"}}>No contacts inculded</Text>
                    </Body>
					<Right>
						<Button transparent>
