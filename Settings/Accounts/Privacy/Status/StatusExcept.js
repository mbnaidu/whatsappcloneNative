...
export default function StatusExcept({navigation}) {
	...
	return (
			<Container>
				<Header style={{backgroundColor:"#05F8EC",width:"100%"}} button>
					<Left>
						<Button transparent onPress={()=>{navigation.navigate('Status')}}>
							<Icon name='close' type="MaterialIcons" style={{fontSize: 28,color:"#000000"}}/>
						</Button>
					</Left>
					<Body>
                        <Title onPress={()=>{navigation.navigate('Status')}} style={{color:"#000000"}}>Hide status from ...</Title>
						<Text style={{color:"#000000"}}>No contacts excluded</Text>
                    </Body>
					<Right>
						<Button transparent>
                ...
                <Fab position="bottomRight" style={{backgroundColor:"#05F8EC"}} onPress={()=>{navigation.navigate('Status')}}>
