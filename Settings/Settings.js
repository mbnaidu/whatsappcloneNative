			...
			<Container>
				...
				<ScrollView>
                    <ListItem avatar noBorder button style={{marginBottom: 20}}>
                        ...
                        <Body>
                            <Title style={{color:"#000000"}}>Hanuman</Title>
                    ...
                    <ListItem avatar noBorder button onPress={()=>{navigate('Storage')}}>
                        ...
                        <Body>
                            <Text style={{fontSize:18}}>Storage and data</Text>
                ...
                <Button full light style={{backgroundColor:"#ffffff"}} >
                    ...
                    <Text style={{color:"#000000",fontWeight:"bold",letterSpacing:3}}>MADHU CHARLIE</Text>
                    </Body>
                </Button>
			</Container>
		);
