		...
		<Container>
			{this.state.loged ? (
                ...
                <Body style={{marginTop:"50%"}}>
					...
					<Button full light style={{backgroundColor:"#075E54"}} onPress={()=>{this.login()}}>
				...
				<Container>
					...
					>
						<Tab 
							...
							<Container>
								<ScrollView>
									<ListItem avatar noBorder button onPress={() =>{navigate('ChatPage',{id:'60bf06b82c4f4b4ee4841f3f'})}}>
										<Left>
											<Thumbnail
					...
					<Fab position="bottomRight" style={{backgroundColor:"#25D366"}}>
						<Icon name="chat" type="MaterialIcons" onPress={()=>{navigate('NewMessage')}}/>
					</Fab>
				</Container>
			)}
		</Container>
