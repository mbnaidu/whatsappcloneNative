        ...
        <View style={styles.scrollViewContent}>
            ...
            <Card>
                <CardItem header bordered>
                    <Body>
                        <Text style={styles.firstText}>Mute notifications</Text>
                    </Body>
                    <Right>
                        <Switch
                ...
                <CardItem bordered>
                    <Body>
                        <Text style={styles.firstText}>Custom notifications</Text>
                    </Body>
                </CardItem>
                <CardItem header bordered>
                    <Text style={styles.firstText}>Media visibility</Text>
                </CardItem>
            </Card>
            <Card bordered>
                <CardItem header bordered>
                    <Body>
                        <Text style={styles.firstText}>Disapperaing messages</Text>
                        <Text note>Off</Text>
                    </Body>
                    <Right>
                ...
                <CardItem header bordered>
                    <Body>
                        <Text style={styles.firstText}>Encryption</Text>
                        <Text note>
                            On
                        </Text>
                    </Body>
                    <Right>
                        <Icon name='lock' type="MaterialIcons" style={{fontSize: 28,color:"#075E54"}}/>
                    </Right>
                </CardItem>
            </Card>
            <Card>
                <CardItem bordered>
                    <Text style={{color:"#075E54",fontWeight:"bold"}}>About and phone number</Text>
                </CardItem>
                <CardItem header bordered>
                    <Body>
                        <Text style={styles.firstText}>PUTHINATOR</Text>
                        <Text note>March 10</Text>
                    </Body>
                </CardItem>
                <CardItem header bordered>
                    <Body>
                        <Text style={styles.firstText}>+91 77939 40578</Text>
                        <Text note>Mobile</Text>
                    </Body>
                        <Right>
                            <ListItem noBorder>
                                <Icon name='chat' type="MaterialIcons" style={{fontSize: 28,color:"#075E54",marginRight:20}}/>
                                <Icon name='call' type="MaterialIcons" style={{fontSize: 28,color:"#075E54",marginRight:20}}/>
                                <Icon name='videocam' type="MaterialIcons" style={{fontSize: 28,color:"#075E54"}}/>
                            </ListItem>
                        </Right>
                </CardItem>
            </Card>
            <Card>
                <CardItem header bordered>
                    ...
                    <Body>
                        <Text style={{color:"#C70039",fontWeight:"bold"}}>Block</Text>
                    </Body>
                </CardItem>
            </Card>
            <Card>
                <CardItem header bordered>
                    <Left>
                        ...
                        <Body>
                        <Text style={{color:"#C70039",fontWeight:"bold",alignSelf:"baseline"}}>Report Contact</Text>
                    </Body>
                </CardItem>
            </Card>
        </View>
